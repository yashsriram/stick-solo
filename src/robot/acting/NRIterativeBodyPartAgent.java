...
public class NRIterativeBodyPartAgent {
    ...
    private boolean isPivotTheOriginalOne = true;
    ...
    public void addMilestone(Vec newMilestone) {
        path.add(newMilestone);
    }

    public boolean isPivotTheOriginalOne() {
        return isPivotTheOriginalOne;
    }
    ...
    public void switchPivot() {
        ...
        isPivotTheOriginalOne = !isPivotTheOriginalOne;
    }
